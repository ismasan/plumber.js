        ...
        Binding.prototype.publish = function() {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if ((_ref1 = this.view.formatters[id]) != null ? _ref1.publish : void 0) {
                    value = (_ref2 = this.view.formatters[id])
                        .publish.apply(_ref2, [value].concat(__slice.call(args)));
                }
            }
    ...
    Rivets.binders = {
        ...
        "each-*": {
            ...
            bind: function(el, collection) {
                return el.removeAttribute(['data', this.view.config.prefix, this.type].join('-')
                    .replace('--', '-'));
            },
        ...
        "class-*": function(el, value) {
            ...
            if (!value === (elClass.indexOf(" " + this.args[0] + " ") !== -1)) {
                return el.className = value ? "" + el.className + " " + this.args[0] : elClass.replace(" " + this.args[0] + " ", ' ')
                    .trim();
            }
        },
        "*": function(el, value) {
